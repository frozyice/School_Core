...
namespace School_Core.Migrations
{
    public partial class CanTakeFromYearRenamed : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropColumn(name: "CanTakeFromYear", table: "Lectures");

            migrationBuilder.AddColumn<int>(name: "EnrollableFromYear", table: "Lectures", nullable: false, defaultValue: 0);

            migrationBuilder.InsertData(table: "Lectures", columns: new[] {"Id", "EnrollableFromYear", "FieldOfStudy", "Name", "Status", "TeacherId"},
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(table: "Students", columns: new[] {"Id", "FieldOfStudy", "Name", "YearOfStudy"},
                values: new object[,]
                {
                    {new Guid("df6d8f00-0d7b-460b-b422-e9af773fe6a5"), 0, "Angus", 1}, {new Guid("86ce4f83-190e-4b70-a540-67bae7687d3c"), 1, "Kane", 1},
                    {new Guid("f8a7fa7a-9b64-47c1-bfbc-45248c10de17"), 1, "Lian", 2}, {new Guid("0276092c-67f0-43d2-bcd7-8a7af869a4f5"), 0, "Alissa", 2}
                });

            migrationBuilder.InsertData(table: "Teachers", columns: new[] {"Id", "Name"},
                values: new object[,]
                {
                    {new Guid("c01e9ea1-23f5-4215-930d-4c3d60262187"), "Freestone"}, {new Guid("8fa34838-23c8-42e1-850f-7394d9ffccf5"), "Richmont"},
                    {new Guid("811104f6-d1cf-483f-9dc7-5834d99c03ea"), "Laker"}, {new Guid("155f0dcd-a845-419f-9028-00a02c99f088"), "McCarroll"}
                });
        }

        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(table: "Lectures", keyColumn: "Id", keyValue: new Guid("a1b54f8b-7cb5-492a-b7b7-e274c27a56b6"));

            migrationBuilder.DeleteData(table: "Lectures", keyColumn: "Id", keyValue: new Guid("a625a775-58ce-424f-8b83-c1685d6f3366"));

            migrationBuilder.DeleteData(table: "Lectures", keyColumn: "Id", keyValue: new Guid("ae93d6f0-fcf4-4256-8c04-1939aa3d8e31"));

            migrationBuilder.DeleteData(table: "Lectures", keyColumn: "Id", keyValue: new Guid("d3f3bd63-b5e4-49b4-9b82-087a4caa8a2a"));

            migrationBuilder.DeleteData(table: "Students", keyColumn: "Id", keyValue: new Guid("0276092c-67f0-43d2-bcd7-8a7af869a4f5"));

            migrationBuilder.DeleteData(table: "Students", keyColumn: "Id", keyValue: new Guid("86ce4f83-190e-4b70-a540-67bae7687d3c"));

            migrationBuilder.DeleteData(table: "Students", keyColumn: "Id", keyValue: new Guid("df6d8f00-0d7b-460b-b422-e9af773fe6a5"));

            migrationBuilder.DeleteData(table: "Students", keyColumn: "Id", keyValue: new Guid("f8a7fa7a-9b64-47c1-bfbc-45248c10de17"));

            migrationBuilder.DeleteData(table: "Teachers", keyColumn: "Id", keyValue: new Guid("155f0dcd-a845-419f-9028-00a02c99f088"));

            migrationBuilder.DeleteData(table: "Teachers", keyColumn: "Id", keyValue: new Guid("811104f6-d1cf-483f-9dc7-5834d99c03ea"));

            migrationBuilder.DeleteData(table: "Teachers", keyColumn: "Id", keyValue: new Guid("8fa34838-23c8-42e1-850f-7394d9ffccf5"));

            migrationBuilder.DeleteData(table: "Teachers", keyColumn: "Id", keyValue: new Guid("c01e9ea1-23f5-4215-930d-4c3d60262187"));

            migrationBuilder.DropColumn(name: "EnrollableFromYear", table: "Lectures");

            migrationBuilder.AddColumn<int>(name: "CanTakeFromYear", table: "Lectures", type: "int", nullable: false, defaultValue: 0);
